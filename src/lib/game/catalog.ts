...
export const ITEMS: Record<string, ItemDef> = {
  ...
  "craft-1": i({
    id: "craft-1",
    name: "Brass Shim",
    blurb: "The smallest honest fitting. The pier has asked for thousands.",
    chain: "craft",
    tier: 1,
    nextId: "craft-2",
    sell: 1,
  ...
  "craft-2": i({
    id: "craft-2",
    name: "Rigging Cleat",
    blurb: "Cast, filed, and bolted down. It only has one job and it never argues.",
    chain: "craft",
    tier: 2,
    nextId: "craft-3",
    sell: 2,
  ...
  "craft-3": i({
    id: "craft-3",
    name: "Ship's Bell",
    blurb: "Struck once for the hour, twice for weather coming.",
    chain: "craft",
    tier: 3,
    nextId: "craft-4",
    sell: 4,
  ...
  "craft-4": i({
    id: "craft-4",
    name: "Bullseye Glass",
    blurb: "A thick green disc. Holds the light and bends it kindly.",
    chain: "craft",
    tier: 4,
    nextId: "craft-5",
    sell: 7,
  ...
  "craft-5": i({
    id: "craft-5",
    name: "Signal Mirror",
    blurb: "Brass back, true face. It has called two boats home this year.",
    chain: "craft",
    tier: 5,
    nextId: "craft-6",
    sell: 12,
  ...
  "craft-7": i({
    id: "craft-7",
    name: "Sextant",
    blurb: "Brass arms and a smoked glass. It measures the distance to somewhere better.",
    chain: "craft",
    tier: 7,
    nextId: "craft-8",
    sell: 28,
  ...
  "craft-10": i({
    id: "craft-10",
    name: "Harbor Beacon",
    blurb: "The cove's own light, rebuilt from the pieces the storm left.",
    chain: "craft",
    tier: 10,
    nextId: null,
    sell: 75,
